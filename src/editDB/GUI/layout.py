...
from src.editDB.dbFunctions import getAllRooms, addRoom as dbAdd, deleteRoom as dbDelete, updateCapacity as dbUpdate
...
def getTableRooms():
    rooms = getAllRooms()
    return [
        {'id': room[0], 'room_name': room[1], 'capacity': room[2]}
        for room in rooms
    ]
